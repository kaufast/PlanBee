      ...
      <div className="block-feature mt-180 lg-mt-150 md-mt-120">
         <div className="row align-items-center">
            <div className="col-lg-6 me-auto">
               ...
               <p className="fs-22 mt-40 lg-mt-30 mb-40 lg-mb-30">PlanBee Secure VPN safeguards your online activities from prying hackers, whether you&apos;re connected to public Wi-Fi or your home network, ensuring privacy.</p>
