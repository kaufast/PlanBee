...
import person from "@/assets/images/assets/person2.png"
         ...
         <div className="container">
            <div className="row">
               <div className="col-xl-6 col-lg-7 col-md-10">
                  <h1 className="hero-heading">Better than Plan A, is <span>Plan B</span></h1>
                  <p className="fs-28 text-white font-manrope pt-35 lg-pt-20 pb-40 lg-pb-20 pe-xxl-5">Seamlessly integrate teams, tasks, & documents with the all-in-one PlanB app.</p>
