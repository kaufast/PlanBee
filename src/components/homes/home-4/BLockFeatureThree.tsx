               ...
               <div className="row align-items-center">
                  <div className="col-lg-6 order-lg-last">
                     <div className="ms-lg-5">
                        ...
                        <p className="fs-28 mt-30 mb-50 md-mb-30">Broaden PlanBee’s line potential by leveraging its compatibility with a vast array of apps and integration solutions.</p>
