            ...
            <div className="row">
               <div className="col-lg-7 me-auto">
                  <div className="pe-xxl-5">
                     ...
                     <blockquote className="p0">PlanBee is the leading AI solution for optimizing B2B SaaS campaigns, ensuring unparalleled success  and efficiency.</blockquote>
                     <div className="media-block border-30 mt-70 lg-mt-30 d-flex align-items-end">
                        <div className="name-card w-100 d-flex align-items-center justify-content-between">
                           <div>
                              <h6>Maria Gomez</h6>
                              <span className="text-dark">CEO & Founder, PlanBee inc</span>
                           </div>
